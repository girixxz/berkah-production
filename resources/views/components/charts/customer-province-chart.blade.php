{{-- Component: Customer Province Bar Chart (Vertical) --}}
<div x-data="{
    chart: null,
    loading: false,
    ...
    fetchData() {
        ...
        fetch('/owner/dashboard/chart/customer-province?year=' + this.selectedYear + '&month=' + this.selectedMonth, {
            headers: {
    ...
    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 mb-2">
        <h3 class="text-center md:text-left text-lg font-bold text-gray-900">Order By Province</h3>
