    ...
    <div class="content-wrapper">
        ...
        <div class="grid-2">
            ...
            <div>
                ...
                <div style="text-align: center; padding: 10px; border: 2px solid black; border-top: 0; height: 200px; display: flex; align-items: center; justify-content: center;">
...
{{-- PAGE 4: JAHIT & PACKING (Split) --}}
<div class="page">
    {{-- TOP HALF: JAHIT --}}
    <div style="height: 48%; border-bottom: 2px solid black; position: relative;">
