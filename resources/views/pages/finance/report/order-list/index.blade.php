...
@section('content')
    ...
    <div x-data="{
        ...
        <div id="stats-section" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
            {{-- Total Orders (merged with Total QTY) --}}
            <div class="bg-white border border-gray-200 rounded-lg p-4">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm text-gray-500">Total Orders</p>
                        <p class="text-2xl font-bold text-gray-900 mt-1">{{ number_format($stats['total_orders']) }} <span class="text-sm font-medium text-gray-500 italic">( {{ number_format($stats['total_qty']) }} Pcs )</span></p>
                    </div>
            ...
            <div class="bg-white border border-gray-200 rounded-lg p-4">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-green-700 mt-1">Rp {{ number_format($stats['total_paid'], 0, ',', '.') }}</p>
                    </div>
            ...
            <div class="bg-white border border-gray-200 rounded-lg p-4">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-red-600 mt-1">Rp {{ number_format($stats['remaining_due'], 0, ',', '.') }}</p>
                    </div>
